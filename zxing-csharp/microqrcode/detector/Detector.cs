...
using Version = com.google.zxing.microqrcode.decoder.Version;

namespace com.google.zxing.microqrcode.detector
{
    ...
    public class Detector
    {
        ...
        public virtual PerspectiveTransform createTransform(ResultPoint topLeft, ResultPoint topRight, ResultPoint bottomLeft, int dimension)
        {
